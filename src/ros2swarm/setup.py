...
setup(
    ...
    description='Contains swarm behaviour pattern implementations. '
                ...
                'Movement: Basic: drive, dispersion, attraction, aggregation, magnetometer, minimalist flocking, TODO'
                'Combined: flocking, TODO'
    ...
    entry_points={
        'console_scripts': [
            ...
            # message pump
            'message_pump = ros2swarm.message_pump:main',
            ...
            'flocking_pattern = '
            'ros2swarm.movement_pattern.combined.flocking_pattern:main',
            'flocking_pattern2 = '
            'ros2swarm.movement_pattern.combined.flocking_pattern2:main',
