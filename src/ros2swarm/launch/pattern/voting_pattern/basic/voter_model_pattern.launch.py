...
def generate_launch_description():
    """Start the nodes required for the voter model pattern."""
    ...
    ros2_pattern_node = launch_ros.actions.Node(
        package='ros2swarm',
        node_executable='voter_model_pattern',
        node_namespace=robot_namespace,
        output='screen',
        parameters=[
            os.path.join(config_dir, 'voting_pattern', 'basic', 'voter_model_pattern.yaml')],
