...
def generate_launch_description():
    """Start the nodes required for the minimalist flocking pattern."""
    ...
    ros2_pattern_node = launch_ros.actions.Node(
        package='ros2swarm',
        executable='minimalist_flocking_pattern',
        namespace=robot_namespace,
        output='screen',
        parameters=[
            PathJoinSubstitution([config_dir, 'movement_pattern', 'basic', 'minimalist_flocking_pattern.yaml'])],
