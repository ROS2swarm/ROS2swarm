...
#node used to spawn and give virtual items to the robots. Use items_container to manage them.
class ItemsMaster(Node):
    def __init__(self):
        ...
        self.timer_add_items = self.create_timer(10, self.timer_add_items_callback) #adding items randomly

        self.timer_add_once = self.create_timer(400, self.add_items_once_callback) #adding items once
